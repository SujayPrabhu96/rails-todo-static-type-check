...
class Todo
  ...
  module CommonRelationMethods
    ...
    sig do
      params(
        records: T.any(::Todo, Integer, String, T::Enumerable[T.any(::Todo, Integer, String, T::Enumerable[::Todo])])
      ).returns(Integer)
    end
    ...
    sig { params(args: T.untyped).returns(T::Array[::Todo]) }
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_completed?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_completed?(from: T.unsafe(nil), to: T.unsafe(nil)); end
